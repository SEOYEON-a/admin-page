...
//	}
	...
	// 현재씨 코드 참조
//	@Override
//	public List<popStoreVO> getList(int psNo, String psName, Criteria cri) {
...
//	    List<popStoreVO> result = mapper.getList(params);
//	    return result;
//	}
...
//	}
	...
	public List<signInVO> getListBySearchMs(String searchMs) {
		return mapper.getListBySearchMs(searchMs);
	}
...
//    int result1 = mapper.catInsert(pcatvo);        
...
//        }
//
//        int result2 = amapper.imgInsert(image); // 이미지 정보 DB에 삽입
//    }
//		 이중 insert??!!
//    pImgVO image = new pImgVO();
//    image.setPsNo(psvo.getPsNo());
...
//			return psInsert(result1, result2, result3); /// 내가 생각한 코드
//		}
//	
//		// 파일저장
...
//			  return int psInsert(result1, result2, result3); 
//	    }
